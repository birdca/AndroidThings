...
![Schematics for Raspberry Pi 3](SevenSegments.png)
...
- [Android Things Tutorial（九）GPIO輸出 - 七段顯示器](http://www.codedata.com.tw/java/att09/)
- [Arduino 筆記 – Lab7 使用七段顯示器製作倒數功能](http://coopermaa2nd.blogspot.tw/2010/12/arduino-lab7.html)
